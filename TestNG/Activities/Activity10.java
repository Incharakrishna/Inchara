...
public class Activity10 {
	...
	public static Object[][] signUpInfo() {
		String filePath = "src/test/java/Activity/employees.xlsx";
	...
	public void registerTest(List<String> rows) throws InterruptedException {
		...
		fullName.sendKeys(rows.get(1));
		// Enter the email
		driver.findElement(By.id("email")).sendKeys(rows.get(2));
		// Enter the Date of the event
		driver.findElement(By.name("event-date")).sendKeys(rows.get(3).replaceAll("\"", ""));
		// Enter additional details
		driver.findElement(By.id("additional-details")).sendKeys(rows.get(4));
		// Click Submit
